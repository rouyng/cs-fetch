...
class CfGuiControl:
    ...
    def _errorStatus(self, error_text):
        self._view.statusbar.showMessage(f'Error: {error_text}', 5000) # show error in status bar for 5 sec

# TODO: Request timer ('results returned in x sec' in status bar)
# TODO: make results table read-only
